...
class WeatherDataModel {
    ...
    ///Current temperature.
    var temperature: Measurement = Measurement(value: 0.0, unit: UnitTemperature.celsius)
    ///Current wind speed.
    var windSpeed: Measurement = Measurement(value: 0.0, unit: UnitSpeed.metersPerSecond)
    ///Current city.
    var city: String = ""
